        ...
        if(ppo_buscado == NULL){
            ...
            //Se nao estiver no noh interno (num filho talvez).
                ...
                if(no_chave != raiz){
                    ...
                    */
                    printf("v->folha: %d\n",v->folha);
                    printf("v->numChaves: %d\n",v->numChaves);
                    if((v != NULL) && (v->folha)){   //AQUI PODE DAR PROBLEMA   && (v->numChaves == t-1) && (no_chave == v)
                        printf("deletando caso 3a\n");
                        ...
                        printf("dei um role aqui\n");
                        if((v != NULL) && (!v->folha) && (v->numChaves == t-1)){  //AQUI TAMBEM
                            printf("passei aqui ahha\n");
                            int fg = 0;
