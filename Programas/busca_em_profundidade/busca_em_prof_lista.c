...
*/
    ...
    */
    ...
    int *cor, *antecessor, *tterm, *tdesc;
    cor = (int*) calloc(stp,sizeof(int));
    antecessor = (int*) calloc(stp,sizeof(int));
    tterm = (int*) calloc(stp,sizeof(int));
    tdesc = (int*) calloc(stp,sizeof(int));
